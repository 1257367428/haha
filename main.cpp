...
//  haha
//
//  Created by s20171105117 on 18/7/7.
//  Copyright © 2018年 s20171105117. All rights reserved.
//
#include <iostream>
#include <vector>
#include <string>
...
int main()
{
    FILE *a;
    FILE *b;
    b=fopen("/Users/S20171105117/Desktop/studentdata1.csv","a");
    string s1[200];
    string s2[200];
    string s3[200];
    string s4[200];
    ...
    if ((a=fopen("/Users/S20171105117/Desktop/studentdata.csv","r"))==0)
    {
        printf("nono\n");
    }
